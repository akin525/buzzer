...
//                        $amount=$row["balance"];
        ...
        if ($status=="OK")
        {
            $query=mysqli_query($con,"update wallet set balance=balance-$amount where username='$username'");
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="contact-thumb">
                                <img src="images/paystack_logo.png" class="img-circle img-responsive" alt="">
                            </div>
                        </td>
                        <td>
                            <h4><b>Paystack</b></h4>
...
<td>
    <div class="contact-thumb">
        <img src="images/flutterwave_logo.png" class="img-circle img-responsive" alt="">
    </div>
</td>
<td>
...
<td>
    <div class="contact-thumb">
        <img src="images/payant_logo.png" class="img-circle img-responsive" alt="">
    </div>
</td>
<td>
    <div class="contact-detail">
...
if($numrows==1) {
    ...
    <tr>
        <td>
            <div class="contact-thumb">
                <img src="images/wallet.png" class="img-circle img-responsive" alt="">
            </div>
        </td>
        <td>
            <div class="contact-detail">
