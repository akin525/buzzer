...
if ( $balance<$topay ) {
    $msg = $msg . "You Cant Make Purchase Above" . "NGN" . $topay . " from your wallet. Your wallet balance is NGN $balance. Please Fund Wallet And Retry or Pay Online Using Our Alternative Payment Methods.";
    echo "<script>alert('" . $msg . "'); </script>";
}else if ($topay<0){
    echo "<script>
 window.location='dashboard.php';</script>";
} else {
$query=mysqli_query($con,"update wallet set balance=balance-$topay where username='$username'");
...
$subject = "$username|Transactional Email | $net";
                     ...
                     <tr>
                      <td align='left' style='padding:0;Margin:0;padding-top:5px;padding-bottom:10px'><span>Dear&nbsp;</span><strong>$username</strong><span>,</span><br><span>A payment was successfully completed on your account.</span><br><span>Please see below details of the transaction:</span>
                       <ul>
                        ...
                        <li style='-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, helvetica neue, helvetica, sans-serif;line-height:21px;Margin-bottom:15px;color:#333333;font-size:14px'>Reference Number: <strong>$net</strong></li>
...
<div style="padding:90px 15px 20px 15px">
    ...
    <div class="alert alert-warning" id="PayNote" style="font-weight: bold;font-size: 13px;">
        ...
        Dear <?php echo $name2; ?>! Your Account privacy is important to us, as this might be need by our technical team for assistant when needed. Keep Safe.
